//
//  RPPGViewController.swift
//  GraduationProj
//
//  Created by Naira Bassam on 28/06/2021.
//
...
class RPPGViewController: UIViewController {
...
extension RPPGViewController: AVCaptureVideoDataOutputSampleBufferDelegate {
